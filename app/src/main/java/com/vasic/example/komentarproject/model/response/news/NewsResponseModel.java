package com.vasic.example.komentarproject.model.response.news;
...
public class NewsResponseModel  {
    ...
    public NewsResponseModel(int id, String image, String image_source, String author_name,
                String source, CategoryResponseModel category, String title, String description,
